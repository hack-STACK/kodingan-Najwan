//SUB CLASS MANAGER (2) START !!!!
package inherintance;
import java.util.Scanner;
public class manager extends employee {
        //disini kita mulai membuat scanner guna untuk input data si user dan gaji kita set ke 8 juta
        Scanner input = new Scanner(System.in); //scanner untuk inputan si user 
        double gaji = 8; //boss = 20 juta , manager = 8 juta , cleaning service = 3 juta , securtiy = 2 juta
